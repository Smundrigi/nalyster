...
public class IssueWindow extends JFrame {
    ...
    private void updateCustomIdList(int oldID) {
        ...
        projectManager.getOpeningIssuesList().remove(table.getName() + oldID);
    ...
    private void issueWindowClosing() {
        if (addIssueMode) {
            ...
            if (issue.getId() == originalId + 9000)
                projectManager.getOpeningIssuesList().remove(table.getName()+ originalId); 
            else
                projectManager.getOpeningIssuesList().remove(table.getName()+ issue.getId()); 
    ...
    private void updateComboList(String colName) {
        ...
        for (int col = 0; col < table.getColumnCount(); col++) {
            ...
            if (table.getColumnName(col).equalsIgnoreCase(colName)) {
                ...
                /* Declared a final Object variable
                   Author:swapna 
                   Date:28th Sept 2017 */
