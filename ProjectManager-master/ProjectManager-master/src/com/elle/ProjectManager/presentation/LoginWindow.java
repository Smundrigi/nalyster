...
public class LoginWindow extends JFrame {
    ...
    public String getUserName() 
    {
        ...
        /*
          ...
          @Issue:Arrayoutofbound Exception handled
        */
        String userNameToPM = null;
        /*If string length is less than 7*/
        if((userName.length())< 7)
        {
            userNameToPM = "pupone";
            JOptionPane.showMessageDialog(this,
                    "Invalid Username","ERROR_MSG",
                   JOptionPane.ERROR_MESSAGE);
       
        }
        else
        {
            userNameToPM = userName.substring(7);
        }
        return userNameToPM;
    }
    ...
    public void login() throws IOException, BadLocationException 
    {
        ...
        /*
        @Author:Swapna
        @Date:#rd October 2017
        @Comments:Null password or username issue is handled
        */
