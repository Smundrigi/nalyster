...
public class Tab implements ITableConstants {
    ...
    */
    ...
    private void setTableHeaderListeners() {
        ...
        /*Author:Swapna
          Date 28th Sept 2017*/
          final JTableHeader headerTemp = header;
            ...
            header.addMouseListener(new MouseAdapter() 
            {
                ...
                public void mouseClicked(MouseEvent e) 
                {
                    ...
                    if (e.getClickCount() == 1 && e.getButton() == MouseEvent.BUTTON1 && !e.isConsumed()) {
                        int columnIndex = headerTemp.columnAtPoint(e.getPoint());
                        if (columnIndex != -1) {
    ...
    private void setTableBodyListeners() {
        ...
        /*Author:Swapna
        Date 28th Sept 2017
        Temp variable to use within inner classes*/
        
        final Tab localTabtemp = localTab;
                    ...
                    if (e.getClickCount() == 2) {
                        ...
                        if (e.isControlDown()) {
                            ...
                            if (e.getComponent() instanceof JTable) {                                
                                int row = table.getSelectedRow();
                                pmWindow.openIssueWindow(row, localTabtemp);
                            }
                        }
                    } else {
                        if (e.getClickCount() == 1) {
                            if (e.getComponent() instanceof JTable) {
                                ...
                                if (rows.length >= 2) {
                                    ...
                                    pmWindow.changeTabbedPanelState(localTabtemp);
